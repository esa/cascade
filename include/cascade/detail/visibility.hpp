...
#ifndef CASCADE_DETAIL_VISIBILITY_HPP
#define CASCADE_DETAIL_VISIBILITY_HPP
...
#if defined(cascade_EXPORTS)

#define CASCADE_DLL_PUBLIC __declspec(dllexport)

#else

#define CASCADE_DLL_PUBLIC __declspec(dllimport)

#endif

#define CASCADE_DLL_LOCAL

#elif defined(__clang__) || defined(__GNUC__) || defined(__INTEL_COMPILER)

#define CASCADE_DLL_PUBLIC __attribute__((visibility("default")))
#define CASCADE_DLL_LOCAL __attribute__((visibility("hidden")))

#else

#define CASCADE_DLL_PUBLIC
#define CASCADE_DLL_LOCAL
...
#define CASCADE_DLL_PUBLIC_INLINE_CLASS

#else

#define CASCADE_DLL_PUBLIC_INLINE_CLASS CASCADE_DLL_PUBLIC
